...
celery_app.conf.update(
    ...
    # Periodic housekeeping: sweep stale local workspaces + stuck Redis job records.
    # Run via: celery -A app.core.celery_app.celery_app beat
    beat_schedule={
        "system-maintenance-sweep": {
            "task": "system_maintenance_task",
